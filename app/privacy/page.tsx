  ...
  const contents = [
    ...
    },
    {
      ...
      content: [
        ...
        `9. Log Files`,
        `Dodong follows a standard procedure of using log files. These files log visitors when they visit websites.`,
    ...
    },
    {
      ...
      content: [
        `Like any other website, Dodong uses 'cookies'. These cookies are used to store information including
        ...
        `,
        `For more general information on cookies, please read the Cookies article on Generate Privacy Policy
        website.`,
      ],
    },
    {
    ...
    {
      title: "Google",
      content: ["https://policies.google.com/technologies/ads"],
    },
    {
      title: "Advertising Partners Privacy Policies",
      content: [
        `You may consult this list to find the Privacy Policy for each of the advertising partners of Dodong.
        `,
        `Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that
        are used in their respective advertisements and links that appear on Dodong, which are sent directly to
        ...
        `,
        `Note that Dodong has no access to or control over these cookies that are used by third-party
        advertisers.`,
      ],
    },
    {
      ...
      content: [
        `Dodong's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
    ...
    },
    {
      ...
      content: [
        ...
        `,
        `Dodong does not knowingly collect any Personal Identifiable Information from children under the age of
