  ...
  return (
    <section className='w-full h-screen bg-profile-back flex flex-col  items-center'>
        ...
        <main className=' mt-10 flex flex-col justify-center items-center'>
            <h4 className='bg-000000 font-medium'>You now have only 3 steps to complete to connect with your viewers on Dodong. Let’s get started.</h4>
            <h3 className='text-orange-593500 font-bold text-xl mt-5'>0 to 3 <span className='text-#808080'>Steps to follow</span></h3>
            <div className='w-6/12'>
                <div className='w-full flex flex-row  items-center mt-10'>
                  <Image 
                   ...
                   height={49}
                  />
                  <h4 className='font-bold text-2xl text-orange-593500'>Complete Your Profile</h4>
                </div>
                <div className='w-full flex flex-row  items-center mt-10'>
                  <Image 
                   className='mr-5'
                   ...
                   height={49}
                  />
                  <h4 className='font-bold text-2xl text-orange-593500'>Invite Friends</h4>
                </div>
                <div className='w-full flex flex-row  items-center mt-10'>
                  <Image 
                   className='mr-5'
                   ...
                   height={49}
                  />
                  <h4 className='font-bold text-2xl text-orange-593500'>Share Photos and Videos</h4>
                </div>
